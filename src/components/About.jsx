    ...
    <div className="container">
      ...
      <div className="text-content">
        <p className="about">
          ...
          Jobify. Jobify ensures the tests' assessment remains fair, in a world where we often say the tech hiring process
          ...
          amount of data points, e.g., the test results & recorded videos. Jobify also has an admin system to monitor the
