...
const Features = () => {
  return (
    <><div className="main-body">
      ...
      <h1 className="title-text">F.A.Qs</h1>
      ...
      <div className="text-content-body">
        ...
        <p className="text-content">
          ...
          <b>Jobify</b>  is a website that enables job recruiters/posters to post jobs, and at the same time, enables job applicants
        ...
        <p className="text-content">
          ...
          <hr className="title-divider" />
          <b>Jobify</b> ensures the tests' assessment remains fair, in a world where we often say the tech hiring process
        ...
        <p className="text-content">
          ...
          <hr className="title-divider" />
          <b>Jobify</b> also has an admin system to monitor the
